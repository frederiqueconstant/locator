	...
	<div class="flex-column" style="min-width:300px;">
		<!--div>
			...
			<ul style="list-style: decimal;padding-left:2em;">
				<li>Type in the "Search store" field the address of the location (Name of the company and street and
					country)<br></li>
					<li>then click on <button type="button" @click.prevent=""
						class="button button-primary button-large">Search</button> to grab data from Google and
						select
						result<br>
						Then verify that all the address fields are correct. (You can click on <span
						class="replacer">red
					texts</span> to restore previous
					fields)<br>
					Or enter all fields manually<br></li>
					<li>Do not forget to set the correct categories for this location<br></li>
					<li>Save or update post<br></li>
				</ul>
				<hr>
			</div-->
			<div>
			...
			<div :class="{loading:loading}">
				...
				<p>* Selecting result will fill 3)Address, 4) Store details, 5) Google place ID & Geolocation. You can
					then verify the
					fields
				are correct.</p>
				<div class="flex">
			...
			<div class="flex align-start">
						...
						<tr>
							<td>
								<label for="location_settings_name" class="flex align-center m-1">
									<div class="label"> Name <span class="important">(Title of the store - Don't live it
									empty)</span></div>
								</label>
				...
				<div class="map-wrapper">
					<div id="map"></div>
					<button @click.prevent="initMap" class="button button-primary button-large flex align-center" name="refresher" v-if="location_settings_meta.lat.trim && location_settings_meta.lng.trim && location_settings_meta.lat.trim()!='' && location_settings_meta.lng.trim()!=''">Refresh
						map <svg aria-hidden="true" style="width:25px;height:25px" focusable="false" data-icon="sync-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
